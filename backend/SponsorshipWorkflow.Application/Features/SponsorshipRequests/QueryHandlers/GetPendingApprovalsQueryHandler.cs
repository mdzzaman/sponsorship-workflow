...
public class GetPendingApprovalsQueryHandler(IApplicationDbContext db)
    : IRequestHandler<GetPendingApprovalsQuery, PagedResult<SponsorshipRequestResponse>>
{
    public async Task<PagedResult<SponsorshipRequestResponse>> Handle(GetPendingApprovalsQuery request, CancellationToken cancellationToken)
    {
